...
class Engine(object):
    ...
    def contrastive_loss(self, hash1, hash2, margin=0.7):
    ...
    def identify(self, sim_code_center, nlabel, label, noise_level):
        ...
        for epoch in range(self.epochs):
            ...
            for batch_idx, (img, txt, label, nlabel, index) in tqdm(enumerate(self.train_loader)):
                ...
                if epoch < self.warmup_epochs:
                    ...
                    code_center_loss = self.code_center_loss(hash_code, center, nlabel)
                    ...
                    correct_loss = self.code_center_loss(code_correct, center, label_correct)
